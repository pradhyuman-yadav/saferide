...
// Fixture bus position: Indiranagar, Bangalore
...
// Fleet fixture — multiple buses for manager view tests
...
/** Simulate real-time position drift — for use in tests only. */
export function simulateBusMovement(bus: BusState): BusState {
